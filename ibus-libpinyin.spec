...
Source0  : https://sourceforge.net/projects/libpinyin/files/ibus-libpinyin/ibus-libpinyin-1.12.92.tar.gz
...
%prep
%setup -q -n ibus-libpinyin-1.12.92
cd %{_builddir}/ibus-libpinyin-1.12.92
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660229288
