...
Source0  : https://sourceforge.net/projects/libpinyin/files/ibus-libpinyin/ibus-libpinyin-1.15.2.tar.gz
...
%prep
%setup -q -n ibus-libpinyin-1.15.2
cd %{_builddir}/ibus-libpinyin-1.15.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678284778
