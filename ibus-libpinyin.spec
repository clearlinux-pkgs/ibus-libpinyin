...
%prep
%setup -q -n ibus-libpinyin-1.11.93
cd %{_builddir}/ibus-libpinyin-1.11.93
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598894434
...
cp %{_builddir}/ibus-libpinyin-1.11.93/COPYING %{buildroot}/usr/share/package-licenses/ibus-libpinyin/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
