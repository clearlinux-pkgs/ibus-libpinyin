...
Version  : 1.12.91
Release  : 14
URL      : https://sourceforge.net/projects/libpinyin/files/ibus-libpinyin/ibus-libpinyin-1.12.91.tar.gz
Source0  : https://sourceforge.net/projects/libpinyin/files/ibus-libpinyin/ibus-libpinyin-1.12.91.tar.gz
...
%prep
%setup -q -n ibus-libpinyin-1.12.91
cd %{_builddir}/ibus-libpinyin-1.12.91
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649945972
...
cp %{_builddir}/ibus-libpinyin-1.12.91/COPYING %{buildroot}/usr/share/package-licenses/ibus-libpinyin/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
