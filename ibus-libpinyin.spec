...
Version  : 1.10.92
Release  : 3
URL      : https://sourceforge.net/projects/libpinyin/files/ibus-libpinyin/ibus-libpinyin-1.10.92.tar.gz
Source0  : https://sourceforge.net/projects/libpinyin/files/ibus-libpinyin/ibus-libpinyin-1.10.92.tar.gz
...
%prep
%setup -q -n ibus-libpinyin-1.10.92
...
export LANG=C
export SOURCE_DATE_EPOCH=1547344846
