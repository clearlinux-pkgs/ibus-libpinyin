...
Source0  : https://sourceforge.net/projects/libpinyin/files/ibus-libpinyin/ibus-libpinyin-1.16.0.tar.gz
...
%prep
%setup -q -n ibus-libpinyin-1.16.0
cd %{_builddir}/ibus-libpinyin-1.16.0
pushd ..
cp -a ibus-libpinyin-1.16.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739207134
