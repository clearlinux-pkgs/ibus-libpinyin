...
Source0  : https://sourceforge.net/projects/libpinyin/files/ibus-libpinyin/ibus-libpinyin-1.12.1.tar.gz
...
%prep
%setup -q -n ibus-libpinyin-1.12.1
cd %{_builddir}/ibus-libpinyin-1.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631715796
...
cp %{_builddir}/ibus-libpinyin-1.12.1/COPYING %{buildroot}/usr/share/package-licenses/ibus-libpinyin/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
