...
Source0  : https://sourceforge.net/projects/libpinyin/files/ibus-libpinyin/ibus-libpinyin-1.13.0.tar.gz
...
%prep
%setup -q -n ibus-libpinyin-1.13.0
cd %{_builddir}/ibus-libpinyin-1.13.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661190288
