...
Source0  : https://sourceforge.net/projects/libpinyin/files/ibus-libpinyin/ibus-libpinyin-1.15.8.tar.gz
...
%prep
%setup -q -n ibus-libpinyin-1.15.8
cd %{_builddir}/ibus-libpinyin-1.15.8
pushd ..
cp -a ibus-libpinyin-1.15.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721919227
