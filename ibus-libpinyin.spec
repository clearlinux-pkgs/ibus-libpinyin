...
Source0  : https://sourceforge.net/projects/libpinyin/files/ibus-libpinyin/ibus-libpinyin-1.13.1.tar.gz
...
%prep
%setup -q -n ibus-libpinyin-1.13.1
cd %{_builddir}/ibus-libpinyin-1.13.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663250948
