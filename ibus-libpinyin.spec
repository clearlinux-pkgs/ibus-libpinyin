...
Version  : 1.15.7
Release  : 32
URL      : https://sourceforge.net/projects/libpinyin/files/ibus-libpinyin/ibus-libpinyin-1.15.7.tar.gz
Source0  : https://sourceforge.net/projects/libpinyin/files/ibus-libpinyin/ibus-libpinyin-1.15.7.tar.gz
...
%prep
%setup -q -n ibus-libpinyin-1.15.7
cd %{_builddir}/ibus-libpinyin-1.15.7
pushd ..
cp -a ibus-libpinyin-1.15.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706799474
