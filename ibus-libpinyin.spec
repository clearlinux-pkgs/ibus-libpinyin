...
Source0  : https://sourceforge.net/projects/libpinyin/files/ibus-libpinyin/ibus-libpinyin-1.11.92.tar.gz
...
%prep
%setup -q -n ibus-libpinyin-1.11.92
cd %{_builddir}/ibus-libpinyin-1.11.92
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584629625
...
cp %{_builddir}/ibus-libpinyin-1.11.92/COPYING %{buildroot}/usr/share/package-licenses/ibus-libpinyin/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
%make_install
...
/usr/share/package-licenses/ibus-libpinyin/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
